...
void loop() {
  ...
  ///////////////////////////////////////////////////////
  fed3.EnableSleep = false;                             // We need to leave the NeoPixels on for this task but sleep mode shuts them off to save power.  Therefore we must disable sleep mode to run this task.
  if (fed3.FEDmode == 6) {
