...
void loop() {
  ...
  if (fed3.FEDmode == 8) {
    ...
    if (fed3.Left) {                                 44   //If left poke is triggered and pellet is not in the well
      fed3.logLeftPoke();
    }
  }
  ...
  ///////////////////////////////////////////////////////
  if (fed3.FEDmode == 11) {
    fed3.sessiontype = "Timed_Feed";                       //The text in "sessiontype" will appear on the screen and in the logfile
